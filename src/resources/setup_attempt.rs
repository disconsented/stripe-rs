...
use crate::{Account, ApiErrors, Application, Client, Customer, Expandable, List, Mandate, Object, PaymentMethod, RangeQuery, Response, SetupAttemptId, SetupIntent, SetupIntentId, Timestamp};
use crate::params::Expand;
use crate::resources::three_d_secure::ThreeDSecure;
...
pub struct ListSetupAttempts<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ending_before: Option<SetupAttempt>,
