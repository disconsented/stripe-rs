...
impl Object for Application {
	type Id = ();
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "application" }
}
...
impl Object for ApplicationFee {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "application_fee" }
}
...
impl Object for CheckoutSession {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "checkout_session" }
}
...
impl Object for ConnectCollectionTransfer {
	type Id = ();
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "connect_collection_transfer" }
}
...
impl Object for Coupon {
	type Id = CouponId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "coupon" }
}
...
impl Object for Discount {
	type Id = DiscountId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "discount" }
}
...
impl Object for ApplicationFeeRefund {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "fee_refund" }
}
...
impl Object for InvoiceItem {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "invoiceitem" }
}
...
impl Object for IssuingAuthorization {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "issuing.authorization" }
}
...
impl Object for IssuingCard {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "issuing.card" }
}
...
impl Object for IssuingCardholder {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "issuing.cardholder" }
}
...
impl Object for IssuingDispute {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "issuing.dispute" }
}
...
impl Object for IssuingTransaction {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "issuing.transaction" }
}
...
impl Object for Order {
	type Id = OrderId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "order" }
}
...
impl Object for OrderItem {
	type Id = ();
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "order_item" }
}
...
impl Object for OrderReturn {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "order_return" }
}
...
impl Object for Person {
	type Id = PersonId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "person" }
}
...
impl Object for Plan {
	type Id = PlanId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "plan" }
}
...
impl Object for Recipient {
	type Id = RecipientId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "recipient" }
}
...
impl Object for Review {
	type Id = ReviewId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "review" }
}
...
impl Object for ScheduledQueryRun {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "scheduled_query_run" }
}
...
impl Object for Subscription {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "subscription" }
}
...
impl Object for SubscriptionItem {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "subscription_item" }
}
...
impl Object for SubscriptionSchedule {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "subscription_schedule" }
}
...
impl Object for SubscriptionScheduleRevision {
	type Id = ();
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "subscription_schedule_revision" }
}
...
impl Object for TaxId {
	type Id = TaxIdId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "tax_id" }
}
...
impl Object for TaxRate {
	type Id = TaxRateId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "tax_rate" }
}
...
impl Object for Topup {
	type Id = TopupId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "topup" }
}
...
impl Object for Transfer {
	type Id = TransferId;
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "transfer" }
}
...
impl Object for TransferReversal {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "transfer_reversal" }
}
...
impl Object for WebhookEndpoint {
	...
	fn id(&self) -> Self::Id { self.id.clone() }
	fn object(&self) -> &'static str { "webhook_endpoint" }
}
