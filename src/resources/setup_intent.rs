...
use crate::resources::{Account, ApiErrors, Application, Currency, Customer, Mandate, PaymentMethod};
...
impl SetupIntentPaymentMethodOptionsCardRequestThreeDSecure {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            SetupIntentPaymentMethodOptionsCardRequestThreeDSecure::ChallengeOnly => "challenge_only",
        }
    }
}
